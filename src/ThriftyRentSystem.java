...
class  ThriftyRentSystem{
	...
	//Basic format expected from the User
	public static DateFormat format = new SimpleDateFormat("dd/MM/yyyy"); 
	
	/**
	 * This is the method called from main method
	 * this contains the GUI interface for communicating with the user
	 */
    public void run() {

		while (true) {

			System.out.println("\n ------ ThriftyRent User Selection Menu ------\n");
			System.out.println("                            ");
			System.out.println("Add a vehicle:             1");
			System.out.println("                            ");
			System.out.println("Rent a vehicle:            2");
			System.out.println("                            ");
			System.out.println("Return a vehicle:          3");
			System.out.println("                            ");
			System.out.println("Vehicle on Maintenance:    4");
			System.out.println("                            ");
			...
			System.out.println("                            ");
			System.out.println("                            ");
			System.out.println("Use the number pad to enter your choice:");
